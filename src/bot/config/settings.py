...
class Settings:
    ...
    DATABASE_URL: str = os.getenv("DATABASE_URL", "sqlite:///./techno_bot.db")
    ...
    def validate_required_settings(cls) -> bool:
        ...
        # في وضع الاختبار، نتجاهل التحقق من المفاتيح الحقيقية
        if cls.DEBUG and (cls.TELEGRAM_BOT_TOKEN.startswith("test_") or cls.GEMINI_API_KEY.startswith("test_")):
            print("تشغيل في وضع الاختبار - تم تجاهل التحقق من المفاتيح")
            return True
